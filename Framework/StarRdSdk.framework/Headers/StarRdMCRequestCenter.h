...
typedef void (^MCRequestConfigBlock)(__kindof StarRdMCBaseRequest *request);
typedef void (^MCRequestProgressBlock)(NSProgress *progress);

@interface StarRdMCRequestCenter : NSObject
...
/**
 ...
 @return 请求对象
 */
- (__kindof StarRdMCBaseRequest *)sendRequest:(nullable MCRequestConfigBlock)configBlock;
...
/**
 ...
 @return 请求对象
 */
- (__kindof StarRdMCBaseRequest *)sendRequestByAppointedClass:(Class)klass
