//
//  StarRdReaderNoAnimateViewController.h
//  StarRdSdk
//
...
@interface StarRdReaderNoAnimateViewController : UIPageViewController

@property (nonatomic, assign) BOOL isAnimate;// default is YES
